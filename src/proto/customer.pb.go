...
type CustomersInterface struct {
	Cont                 []byte   `protobuf:"bytes,1,opt,name=cont,proto3" json:"cont,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CustomersInterface) Reset()         { *m = CustomersInterface{} }
func (m *CustomersInterface) String() string { return proto.CompactTextString(m) }
func (*CustomersInterface) ProtoMessage()    {}
func (*CustomersInterface) Descriptor() ([]byte, []int) {
	return fileDescriptor_9efa92dae3d6ec46, []int{3}
}

func (m *CustomersInterface) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CustomersInterface.Unmarshal(m, b)
}
func (m *CustomersInterface) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CustomersInterface.Marshal(b, m, deterministic)
}
func (m *CustomersInterface) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CustomersInterface.Merge(m, src)
}
func (m *CustomersInterface) XXX_Size() int {
	return xxx_messageInfo_CustomersInterface.Size(m)
}
func (m *CustomersInterface) XXX_DiscardUnknown() {
	xxx_messageInfo_CustomersInterface.DiscardUnknown(m)
}

var xxx_messageInfo_CustomersInterface proto.InternalMessageInfo

func (m *CustomersInterface) GetCont() []byte {
	if m != nil {
		return m.Cont
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CustomersInterface)(nil), "customer.CustomersInterface")
}
...
var fileDescriptor_9efa92dae3d6ec46 = []byte{
	...
	,
}
...
type CustomerClient interface {
	...
	GetCustomersInterfac(ctx context.Context, in *CustomerFilter, opts ...grpc.CallOption) (Customer_GetCustomersInterfacClient, error)
}
...
func (c *customerClient) GetCustomersInterfac(ctx context.Context, in *CustomerFilter, opts ...grpc.CallOption) (Customer_GetCustomersInterfacClient, error) {
...
func (x *customerGetCustomersInterfacClient) Recv() (*CustomersInterface, error) {
	m := new(CustomersInterface)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CustomerServer interface {
	...
	GetCustomersInterfac(*CustomerFilter, Customer_GetCustomersInterfacServer) error
}
...
func (x *customerGetCustomersInterfacServer) Send(m *CustomersInterface) error {
	return x.ServerStream.SendMsg(m)
}
